...
CREATE TABLE `aula` (
  ...
  CONSTRAINT `dni` FOREIGN KEY (`dni_profesor`) REFERENCES `usuario` (`dni`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `log` (
  ...
  `log_info` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_log`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES ('45140387j','admin','Pepe','Viyuela',NULL,NULL,'admin','admin',''),('45140488j','Alumno','adrian','gil','Masculino',NULL,'adrian@estudiantes','root','null');
...
-- Dump completed on 2020-01-03 18:41:51
